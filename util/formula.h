...
extern double formula_gradient[26][11]; /* Derivatives of expression with respect to certain variables */

/* PROCEDURES. */

double formula(char *, int, int, char *); /* Parse/evaluate formula/gradient */
char *formula_def(char *, int *, int *);  /* Split variable definition */
void formula_sample(char *, char *);      /* Sample variables according to formual of form v~D(...) + ... */
